...
[![latest release badge][]](https://github.com/AH-Merii/fzf.fish/releases)
[![build status badge][]](https://github.com/AH-Merii/fzf.fish/actions)
[![awesome badge][]](https://git.io/awsm.fish)

</div>

> This repository builds on top of [PatrickF1/fzf.fish](https://github.com/PatrickF1/fzf.fish). All credit for the original plugin goes to [@PatrickF1](https://github.com/PatrickF1) and contributors. Please star and support the [original project](https://github.com/PatrickF1/fzf.fish).
...
```fish
fisher install AH-Merii/fzf.fish
```
...
[build status badge]: https://img.shields.io/github/actions/workflow/status/AH-Merii/fzf.fish/continuous_integration.yml?branch=main
[cd docs]: https://fishshell.com/docs/current/cmds/cd.html
[fd]: https://github.com/sharkdp/fd
[fish]: https://fishshell.com
[fisher]: https://github.com/jorgebucaran/fisher
[fzf]: https://github.com/junegunn/fzf
[latest release badge]: https://img.shields.io/github/v/release/AH-Merii/fzf.fish
